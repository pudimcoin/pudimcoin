# Support for Output Descriptors in Pudimcoin Core

Since Pudimcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Pudimcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Pudimcoin Core wallets, a convenience function `combo` is
