...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pudimcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pudimcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pudimcoin transaction") + "\n" +
              "  pudimcoin-tx [options] -create [commands]   " + _("Create hex-encoded pudimcoin transaction") + "\n" +
              "\n";
