...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " pudimcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  pudimcoin-tx [options] <hex-tx> [commands]  Update hex-encoded pudimcoin transaction\n" +
            "or:     pudimcoin-tx [options] -create [commands]   Create hex-encoded pudimcoin transaction\n" +
            "\n";
