...
{
    const char* pszTimestamp = "Pudim é bom de comer de manhã. 18/05/2021 15:30";
    const CScript genesisOutputScript = CScript() << ParseHex("040884710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1621362600, 2000685663, 0x1e0ffff0, 1, 80 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4f63ec5c075d738e5fd396acd3b3261483647c74362ab8dd60673086b43bef11"));
        assert(genesis.hashMerkleRoot == uint256S("0xb28a3022d48442a14d6939a9e2d38649a8cb32a73a2c805487c2012389780786"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("207.246.71.24", "207.246.71.24", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("pudimcointools.com", "dnsseed.pudimcointools.com"));
        //vSeeds.push_back(CDNSSeedData("pudimcoinpool.org", "dnsseed.pudimcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x4f63ec5c075d738e5fd396acd3b3261483647c74362ab8dd60673086b43bef11"))
        ...
        chainTxData = ChainTxData{
            ...
            1621362600, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1621362600, 772814, 0x1e0ffff0, 1, 80 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x553424ad61148e9da5e9a038ba7e126dff4ae369f3be2b6ffecb0988d6d2d52a"));
        assert(genesis.hashMerkleRoot == uint256S("0xb28a3022d48442a14d6939a9e2d38649a8cb32a73a2c805487c2012389780786"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("207.246.71.24", "207.246.71.24"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.pudimcoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x553424ad61148e9da5e9a038ba7e126dff4ae369f3be2b6ffecb0988d6d2d52a ")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1621362600, 0, 0x207fffff, 1, 80 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xaa23d4614c2cbfc1a486a5d81ef92ffa60ca9beb85c68080e63cc12a5c646845"));
        assert(genesis.hashMerkleRoot == uint256S("0xb28a3022d48442a14d6939a9e2d38649a8cb32a73a2c805487c2012389780786"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xaa23d4614c2cbfc1a486a5d81ef92ffa60ca9beb85c68080e63cc12a5c646845 "))
        };
