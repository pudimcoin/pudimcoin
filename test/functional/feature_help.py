...
"""Verify that starting pudimcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pudimcoin with -h for help text")
        ...
        self.log.info("Start pudimcoin with -version for version information")
        ...
        self.log.info("Start pudimcoind with -fakearg to make sure it does not start")
